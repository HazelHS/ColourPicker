...
"""
from color_utils import hsv_to_rgb255, rgb_to_hex, get_colour_name, get_color_info
...
def get_gradient_color_at_index(
    ...
    Returns:
        Dictionary with color information (rgb, hex, name, opp_h, opp_rgb, opp_hex, opp_name)
    """
